...
for task in GLUE_TASKS:
    ...
    class CombinedModel(nn.Module):
        def __init__(self, base_model, model1, model2, model3,model4, model5, num_labels,hidden_size):
            ...
            self.model=[self.model1,self.model2,self.model3,self.model4,self.model5]
