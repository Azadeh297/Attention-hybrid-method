...
for task in GLUE_TASKS:
    ...
    class CombinedModel(nn.Module):
        def __init__(self, base_model, model1, model2, model4, model5, model7, model8, model9, num_labels,hidden_size):
            ...
            self.model8 = model8
            self.model9 = model9
            self.model=[self.model1,self.model2,self.model4,self.model5,self.model7,self.model8,self.model9]
    ...
    combined_model = CombinedModel(base_model, model_task1,model_task2, 
                                model_task4,model_task5, 
