...
model_task1 = AutoModelForSequenceClassification.from_pretrained(model_dir,ignore_mismatched_sizes=True, output_hidden_states=True).to(device)
for param in model_task1.parameters():
    param.requires_grad = False
#------------------TASK2
model_dir = 'Bert_lora_mnli-mm'
model_task2 = AutoModelForSequenceClassification.from_pretrained(model_dir,num_labels=3,ignore_mismatched_sizes=True, output_hidden_states=True).to(device)
for param in model_task2.parameters():
    param.requires_grad = False
#------------------TASK3
model_dir = 'Bert_lora_mnli'
model_task3 = AutoModelForSequenceClassification.from_pretrained(model_dir,num_labels=3,ignore_mismatched_sizes=True, output_hidden_states=True).to(device)
for param in model_task3.parameters():
    param.requires_grad = False
#------------------TASK4
model_dir = 'Bert_lora_mrpc'
model_task4 = AutoModelForSequenceClassification.from_pretrained(model_dir,ignore_mismatched_sizes=True, output_hidden_states=True).to(device)
for param in model_task4.parameters():
    param.requires_grad = False
#------------------TASK5
model_dir = 'Bert_lora_qnli'
model_task5 = AutoModelForSequenceClassification.from_pretrained(model_dir,ignore_mismatched_sizes=True, output_hidden_states=True).to(device)
for param in model_task5.parameters():
    param.requires_grad = False
#------------------TASK6
model_dir = 'Bert_lora_qqp'
model_task6 = AutoModelForSequenceClassification.from_pretrained(model_dir,ignore_mismatched_sizes=True, output_hidden_states=True).to(device)
for param in model_task6.parameters():
    param.requires_grad = False
#------------------TASK7
model_dir = 'Bert_lora_rte'
model_task7 = AutoModelForSequenceClassification.from_pretrained(model_dir,ignore_mismatched_sizes=True, output_hidden_states=True).to(device)
for param in model_task7.parameters():
    param.requires_grad = False
#------------------TASK8
model_dir = 'Bert_lora_sst2'
model_task8 = AutoModelForSequenceClassification.from_pretrained(model_dir,ignore_mismatched_sizes=True, output_hidden_states=True).to(device)
for param in model_task8.parameters():
    param.requires_grad = False
#------------------TASK9
model_dir = 'Bert_lora_wnli'
model_task9 = AutoModelForSequenceClassification.from_pretrained(model_dir,ignore_mismatched_sizes=True, output_hidden_states=True).to(device)
...
base_model = AutoModelForSequenceClassification.from_pretrained(model_checkpoint,ignore_mismatched_sizes=True, num_labels=num_labels, output_hidden_states=True).to(device)
