...
for task in GLUE_TASKS:
    ...
    #------------------TASK2
    model_dir = 'El_small_lora_mnli-mm'
    ...
    class CombinedModel(nn.Module):
        ...
        def forward(self, input_ids, attention_mask, token_type_ids=None, labels=None):
            ...
            attn_output, attention_scores = self.attention(combined_outputs, combined_outputs, combined_outputs, need_weights=True)
